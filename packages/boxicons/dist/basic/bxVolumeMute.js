export var bxVolumeMute = [
  ...
  [
    ...
    [
      "path",
      {
        "d": "m12,18.13l-4.45-2.96s-.06-.02-.08-.03c-.06-.03-.12-.06-.19-.08-.07-.02-.13-.03-.2-.04-.03,0-.06-.02-.09-.02h-3v-6h.76l-1.73-1.73c-.61.34-1.02.99-1.02,1.73v6c0,1.1.9,2,2,2h2.7l5.75,3.83c.17.11.36.17.55.17.16,0,.32-.04.47-.12.33-.17.53-.51.53-.88v-1.76l-2-2v1.89Z"
      }
    ]
  ]
];
