export var bxBaseball = [
  ...
  [
    ...
    [
      "path",
      {
        "d": "M14.81 12.78c-.4.27-.77.58-1.11.92s-.65.71-.92 1.11c-.11.17-.22.34-.32.52l1.74.98c.07-.13.15-.26.23-.38.2-.29.42-.57.67-.82s.52-.48.81-.67c.12-.08.25-.16.38-.24l-.98-1.74c-.18.1-.35.21-.52.32ZM9.56 8.07c-.2.29-.42.57-.67.82s-.52.48-.81.67c-.12.08-.25.16-.38.24l.98 1.74c.18-.1.35-.21.52-.32.4-.27.77-.58 1.11-.92s.65-.71.92-1.11c.11-.17.22-.34.32-.52l-1.74-.98c-.07.13-.15.26-.23.38Z"
      }
    ]
  ]
];
