export var thunderstormTwotone20px = [
  "g",
  {},
  [
    [
      "path",
      {
        "d": "M14.5,7.5h-1.1l-0.19-1.26C12.96,4.69,11.62,3.5,10,3.5c-1.32,0-2.45,0.78-2.96,1.91L6.75,6h-0.5 C4.73,6,3.5,7.23,3.5,8.75c0,1.52,1.23,2.75,2.75,2.75h8.25c1.1,0,2-0.9,2-2C16.5,8.4,15.6,7.5,14.5,7.5z",
        "opacity": ".3"
      }
    ],
    [
