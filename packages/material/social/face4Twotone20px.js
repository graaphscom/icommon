export var face4Twotone20px = [
  ...
  [
    [
      "path",
      {
        "d": "M3.89,7.82c1.49-0.74,2.66-2.04,3.23-3.62C5.62,4.94,4.45,6.23,3.89,7.82z",
        "opacity": ".3"
      }
    ],
    [
      "path",
      {
        "d": "M15.41,6.43c-0.44-0.67-2.63-3.54-6.57-2.82C9.31,4.25,11.49,6.95,15.41,6.43z",
        "opacity": ".3"
      }
    ],
    [
      "path",
      {
        "d": "M6.25,2.93C5.85,2.09,5,1.5,4,1.5C2.62,1.5,1.5,2.62,1.5,4c0,1,0.59,1.85,1.43,2.25 C3.68,4.84,4.84,3.68,6.25,2.93z",
        "opacity": ".3"
      }
    ],
    [
