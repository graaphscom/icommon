export var macroOffRound24px = [
  ...
  [
    [
      "path",
      {
        "d": "M4.2,13.08c-0.64-0.09-1.21,0.48-1.12,1.12C3.67,18.6,7.44,22,12,22C12,17.44,8.6,13.67,4.2,13.08z"
      }
    ],
    [
      "path",
    ...
    [
      "path",
      {
        "d": "M19.98,17.15c0.47-0.91,0.8-1.9,0.94-2.95c0.09-0.64-0.48-1.21-1.12-1.12c-1.05,0.14-2.05,0.47-2.95,0.94L19.98,17.15z"
      }
    ],
    [
      "path",
      {
        "d": "M2.1,3.51L2.1,3.51c-0.39,0.39-0.39,1.02,0,1.41l3.93,3.93c-0.35,0.52-0.53,1.17-0.38,1.89c0.22,1.13,1.26,1.98,2.41,2 c0.54,0.01,1.02-0.15,1.44-0.43l0.02,0.02L9.5,12.5c0,1.38,1.12,2.5,2.5,2.5c0.05,0,0.1-0.01,0.16-0.02l1.64,1.64 C12.67,18.12,12,19.98,12,22c2.02,0,3.88-0.67,5.38-1.79l1.69,1.69c0.39,0.39,1.02,0.39,1.41,0l0,0c0.39-0.39,0.39-1.02,0-1.41 L3.51,3.51C3.12,3.12,2.49,3.12,2.1,3.51z"
      }
    ]
  ]
]