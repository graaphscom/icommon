export var darkModeTwotone20px = [
  "svg",
  {
  ...
  [
    ...
    [
      "path",
      {
        "d": "M8.04,4.86C7.88,5.39,7.8,5.94,7.8,6.5c0,3.14,2.56,5.7,5.7,5.7c0.56,0,1.11-0.08,1.64-0.24 c-0.79,2.07-2.8,3.54-5.14,3.54c-3.03,0-5.5-2.47-5.5-5.5C4.5,7.66,5.97,5.65,8.04,4.86z",
        "opacity": ".3"
      }
    ],
    [
