export var wifiCalling1Twotone24px = [
  "svg",
  {
        ...
        [
          ...
          [
            [
              "path",
              {
                "d": "M16.49,4.5c1.79,0,3.42,0.73,4.59,1.91l1.06-1.06C20.7,3.9,18.7,3,16.49,3c-2.21,0-4.21,0.9-5.66,2.34 l1.06,1.06C13.08,5.23,14.7,4.5,16.49,4.5z",
                "fillOpacity": ".3"
              }
            ],
            [
              "path",
              {
                "d": "M16.49,6c-1.38,0-2.63,0.56-3.54,1.46l1.06,1.06c0.63-0.63,1.51-1.03,2.47-1.03s1.84,0.39,2.47,1.03 l1.06-1.06C19.12,6.56,17.87,6,16.49,6z",
                "fillOpacity": ".3"
              }
            ],
            [
