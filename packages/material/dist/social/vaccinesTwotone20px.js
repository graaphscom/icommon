export var vaccinesTwotone20px = [
  "svg",
  {
  ...
  [
    ...
    [
      "path",
      {
        "d": "M15.5,14H12v-1h3.5V14z M6,10.5C6,10.78,6.22,11,6.5,11H8v1.5H4.5v-6H8V8H6.5C6.22,8,6,8.22,6,8.5 C6,8.78,6.22,9,6.5,9H8v1H6.5C6.22,10,6,10.22,6,10.5z",
        "opacity": ".3"
      }
    ],
    [
