export var sportsRugbyTwotone20px = [
  "svg",
  {
        ...
        [
          ...
          [
            [
              "path",
              {
                "d": "M14.45,5.55c-1.11,0.1-3.74,0.9-5.86,3.03c-2.16,2.16-2.94,4.81-3.04,5.86c1.11-0.1,3.73-0.9,5.86-3.03 C13.57,9.25,14.35,6.6,14.45,5.55z",
                "opacity": ".3"
              }
            ],
            [
              "path",
              {
                "d": "M7.88,7.88c1.36-1.36,2.94-2.25,4.3-2.76C11.03,5.19,8.8,5.54,7.17,7.17c-1.43,1.43-1.95,3.41-2.05,4.98 C5.64,10.8,6.53,9.23,7.88,7.88z",
                "opacity": ".3"
              }
            ],
            [
              "path",
              {
                "d": "M12.12,12.12c-1.36,1.36-2.94,2.25-4.3,2.76c1.15-0.07,3.38-0.43,5.01-2.06c1.43-1.43,1.95-3.41,2.05-4.98 C14.36,9.2,13.47,10.77,12.12,12.12z",
                "opacity": ".3"
              }
            ],
            [
